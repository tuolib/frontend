...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'btn': 'px-4 py-2 rounded-8 inline-flex items-center justify-center cursor-pointer transition-colors',
    ...
    'input-base': 'w-full px-3 py-2 border border-gray-300 rounded-8 outline-none transition-colors focus:border-blue-500 focus:ring-1 focus:ring-blue-500',
  },
  theme: {
    colors: {
      primary: {
